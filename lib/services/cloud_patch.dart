/// The complete cloud schema-fix SQL (Supabase patch 8 — the one-paste
/// that supersedes patches 7, 6 and 5), embedded so the in-app "Fix cloud
/// sync" dialog can hand it to the Manager with one tap ("Copy fix SQL")
/// - no repo, no release notes, no support thread.
///
